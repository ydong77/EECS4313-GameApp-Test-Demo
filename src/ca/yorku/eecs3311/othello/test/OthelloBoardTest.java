...
public class OthelloBoardTest {
	...
	@Test
	public void testDiagonalFlipMove() {
		char[][] grid = emptyBoard();
		grid[3][3] = OthelloBoard.P2;
		grid[4][4] = OthelloBoard.P1;
		OthelloBoard diagonalBoard = new OthelloBoard(grid);

		assertTrue(diagonalBoard.move(2, 2, OthelloBoard.P1));
		assertEquals(OthelloBoard.P1, diagonalBoard.get(2, 2));
		assertEquals(OthelloBoard.P1, diagonalBoard.get(3, 3));
		assertEquals(3, diagonalBoard.getCount(OthelloBoard.P1));
		assertEquals(0, diagonalBoard.getCount(OthelloBoard.P2));
	}

	// AI-generated additional JUnit tests
	@Test
	public void testMoveCanFlipInMultipleDirectionsAtOnce() {
		char[][] grid = emptyBoard();
		grid[3][2] = OthelloBoard.P2;
		grid[3][4] = OthelloBoard.P2;
		grid[2][3] = OthelloBoard.P2;
		grid[4][3] = OthelloBoard.P2;
		grid[2][2] = OthelloBoard.P2;
		grid[2][4] = OthelloBoard.P2;
		grid[4][2] = OthelloBoard.P2;
		grid[4][4] = OthelloBoard.P2;

		grid[3][1] = OthelloBoard.P1;
		grid[3][5] = OthelloBoard.P1;
		grid[1][3] = OthelloBoard.P1;
		grid[5][3] = OthelloBoard.P1;
		grid[1][1] = OthelloBoard.P1;
		grid[1][5] = OthelloBoard.P1;
		grid[5][1] = OthelloBoard.P1;
		grid[5][5] = OthelloBoard.P1;
		OthelloBoard multiFlipBoard = new OthelloBoard(grid);

		assertTrue(multiFlipBoard.move(3, 3, OthelloBoard.P1));
		assertEquals(OthelloBoard.P1, multiFlipBoard.get(3, 2));
		assertEquals(OthelloBoard.P1, multiFlipBoard.get(3, 4));
		assertEquals(OthelloBoard.P1, multiFlipBoard.get(2, 3));
		assertEquals(OthelloBoard.P1, multiFlipBoard.get(4, 3));
		assertEquals(OthelloBoard.P1, multiFlipBoard.get(2, 2));
		assertEquals(OthelloBoard.P1, multiFlipBoard.get(2, 4));
		assertEquals(OthelloBoard.P1, multiFlipBoard.get(4, 2));
		assertEquals(OthelloBoard.P1, multiFlipBoard.get(4, 4));
		assertEquals(17, multiFlipBoard.getCount(OthelloBoard.P1));
		assertEquals(0, multiFlipBoard.getCount(OthelloBoard.P2));
	}

	// AI-generated additional JUnit tests
	@Test
	public void testInvalidMoveLeavesCountsUnchanged() {
		int beforeP1 = board.getCount(OthelloBoard.P1);
		int beforeP2 = board.getCount(OthelloBoard.P2);

		assertFalse(board.move(0, 0, OthelloBoard.P1));
		assertEquals(beforeP1, board.getCount(OthelloBoard.P1));
		assertEquals(beforeP2, board.getCount(OthelloBoard.P2));
	}
