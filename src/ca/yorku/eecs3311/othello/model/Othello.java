 ...
 * 
 * Design Patterns: MVC Model for game logic; delegates Visitor to its board; 
 * Command/Memento compatibility via copy().
 * 
 * @author student
 *
 */
public class Othello {
	...
	/**
	 * Construct an Othello game from existing state (used for load/undo/redo).
	 */
	public Othello(OthelloBoard board, char whosTurn, int numMoves) {
	...
	/**
	 * Accept a board visitor (Visitor pattern delegation).
	 */
